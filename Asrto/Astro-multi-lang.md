...
# 2 💡 Что такое i18n-маршрутизация в Astro “по-человечески”
...
### ⚙️ Вариант 2: Использовать Markdown или Content Collections
...
# 3 🧠 Минимальная рабочая конфигурация под мой случай
