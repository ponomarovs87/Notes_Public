...
*порт 1194 практически всегда заблокирован использовать не советую переделать на другой разблокированный в иделе использовать имитацию http/https tсl соединение*
...
client-config-dir /etc/openvpn/ccd
```
**деректория указывается свободно*
...
#### Скопируй этот вариант и замени им существующий **/etc/openvpn/server/server.conf** (или /etc/openvpn/server.conf — если у тебя именно он используется):
